...
const Healthcare = () => {
    ...
    //address from remix
    const contractAddress = "0xE0c431d76285dEe5519DB0C22733dCD96640eb10";
    ...
    const addRecord = async () => {
        try {
            const tx = await contract.addRecord (patientID, "placeholder", diagnosis, treatment);
            await tx.wait();
            fetchPatientRecords();
            await tx.wait()
        } catch (error) {
    ...
    return(
        <div>
            ...
            <div className="form-section">
                ...
                <button className="action-button" onClick={fetchPatientRecords}>Fetch Record</button>
            </div>
